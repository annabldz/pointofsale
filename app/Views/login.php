...
<head>
  ...
  <!-- Favicons -->
  <link href="<?= base_url('assets/img/yey.jpg')?>" rel="icon">
...
<body>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <?php if(session()->getFlashdata('error')): ?>
                  ...
                  <form class="row g-3 needs-validation" id="login-form" action="<?= base_url('aksi_login')?>" method="post" >
  ...
  if (isOnline && grecaptcha.getResponse().length === 0) {
    e.preventDefault();
