    ...
    <div class="pagetitle">
      <h1>Tabel Deleted Guru</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Home</a></li>
          <li class="breadcrumb-item">Table Data</li>
          <li class="breadcrumb-item active">Deleted Data Guru</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <pre></pre>
                <a href="<?= base_url('olimpiade/guru') ?>" class="btn btn-info mb-3 text-white">Back to Guru</a>
                ...
                <tbody>
                  <?php $ms = 1; foreach ($love as $key => $value) { ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?= base_url('olimpiade/guru/restore/' . $value->id_guru) ?>" class="btn btn-danger btn-delete"><i class="bi bi-arrow-counterclockwise"></i></a><pre></pre> <!-- restore -->
                      </td>
                    </tr>
                  <?php } ?>
                </tbody>
