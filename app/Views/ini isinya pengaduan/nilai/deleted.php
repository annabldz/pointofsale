      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <pre></pre>
             <a href="<?= base_url('/user') ?>" class="btn btn-info mb-3 text-white">Back to User</a>
                  ...
                  <?php $ms = 1; foreach ($love as $key => $value) { ?>
                    <tr>
                      ...
                      <td>
                          ...
                          <a href="<?= base_url('/user/restore/' . $value->id_user) ?>" class="btn btn-danger btn-delete"><i class="bi bi-arrow-counterclockwise"></i></a><pre></pre> <!-- restore -->
                        </div>
                      </td>
                    </tr>
                  <?php } ?>
