      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <pre></pre>
              <a href="<?= base_url('/kelas/input') ?>" class="btn btn-success mb-3 text-white"onclick="return confirm('Apakah Anda yakin ingin menambah data kelas?')">Tambah Data Kelas</a>
              <a href="<?= base_url('/kelas/deleted') ?>" class="btn btn-warning mb-3 text-black">Deleted Kelas</a>
                ...
                <tbody>
                  <?php $ms = 1; foreach ($love as $key => $value) { ?>
                    <tr>
                      ...
                      <td>
                        <button class="btn btn-info btn-detail" data-id="<?= $value->id_kelas ?>"><i class="bi bi-info-circle" style="color: white;"></i></button>
                        <div class="btn-group btn-group-action mt-2" id="action-<?= $value->id_kelas ?>" style="display: none;"> 
                          <a href="<?= base_url('/kelas/hapus/' . $value->id_kelas) ?>" class="btn btn-danger btn-delete"><i class="bi bi-trash"></i></a><pre></pre> <!-- hapus -->
                          <a href="<?= base_url('/kelas/edit/' . $value->id_kelas) ?>" class="btn btn-warning"><i class="bi bi-pencil" style="color: white;"></i></a> <!-- edit -->
                        </div>
                      </td>
                    </tr>
                  <?php } ?>
