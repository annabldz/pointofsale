    ...
    <div class="pagetitle">
      <h1>Tabel Deleted Kelas</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Home</a></li>
          <li class="breadcrumb-item">Table Data</li>
          <li class="breadcrumb-item active">Deleted Data Kelas</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <pre></pre>
             <a href="<?= base_url('/kelas') ?>" class="btn btn-info mb-3 text-white">Back to Kelas</a>
                  ...
                  <?php $ms = 1; foreach ($love as $key => $value) { ?>
                    <tr>
                      ...
                      <td>
                          ...
                          <a href="<?= base_url('/kelas/restore/' . $value->id_kelas) ?>" class="btn btn-danger btn-delete"><i class="bi bi-arrow-counterclockwise"></i></a><pre></pre> <!-- restore -->
                        </div>
                      </td>
                    </tr>
                  <?php } ?>
