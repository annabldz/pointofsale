              ...
              <table class="table datatable">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Ekskul Terpilih</th>
                    <th scope="col">Hari Ekskul</th>
                ...
                <tbody>
                  <?php $ms = 1; foreach ($love as $key => $value) { ?>
                    <tr>
                      ...
                      <td><?= $value->status ?></td>
                      <td>
                          <?= $value->disetujui_nama ? $value->disetujui_nama : '-' ?>
                      </td>

                      
                     <td>

<?php if ($value->status == 'Menunggu Persetujuan') { ?>

    <a href="<?= base_url('pendaftaran/approve/' . $value->id_pendaftaran) ?>"
       class="btn btn-success btn-sm">
        Setujui
    </a>
<!-- 
    <a href="<?= base_url('pendaftaran/reject/' . $value->id_pendaftaran) ?>"
...
<?php } else { ?>
    ...
    <!-- kalau sudah disetujui/ditolak, tidak tampil tombol -->
