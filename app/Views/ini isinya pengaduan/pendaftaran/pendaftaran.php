        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <pre></pre>
             <a 
  href="<?= base_url('pendaftaran/input') ?>" 
  class="btn btn-success mb-3 text-white" 
  id="btnTambah"
  data-jumlah="<?= $jumlahEkskul ?>"
>
                  ...
                  <?php $ms = 1; foreach ($love as $key => $value) { ?>
                    <tr>
                      ...
                      <td>
                          ...
                          <a href="<?= base_url('pendaftaran/hapus/' . $value->id_pendaftaran) ?>" class="btn btn-danger btn-delete"><i class="bi bi-trash"></i></a><pre></pre> <!-- hapus -->
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    btnTambah.addEventListener('click', function(e){
        ...
        if(jumlah >= 4){
            e.preventDefault();
            alert('Kamu sudah mendaftar 4 ekskul. Tidak bisa daftar lagi.');
        }
    });
