      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <pre></pre>
              <a href="<?= base_url('jadwal/input') ?>" class="btn btn-success mb-3 text-white">Tambah Data Jadwal</a>
    ...
    <?php endif; ?>
                      ...
                      <td>
                        <button class="btn btn-info btn-detail" data-id="<?= $value->id_jadwal ?>"><i class="bi bi-info-circle" style="color: white;"></i></button>
                        <div class="btn-group btn-group-action mt-2" id="action-<?= $value->id_jadwal ?>" style="display: none;"> 
                          <a href="<?= base_url('jadwal/hapus/' . $value->id_jadwal) ?>" class="btn btn-danger btn-delete"><i class="bi bi-trash"></i></a><pre></pre> <!-- hapus -->
                          <a href="<?= base_url('jadwal/edit/' . $value->id_jadwal) ?>" class="btn btn-warning"><i class="bi bi-pencil" style="color: white;"></i></a> <!-- edit -->
                        </div>
                      </td>
                    </tr>
                  <?php } ?>
