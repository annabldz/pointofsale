        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <a href="<?= base_url('barangmasuk/input') ?>" class="btn btn-success mb-3 text-white">Tambah Data Barang Masuk</a>
              <?php if ($level === '1'): ?>
              <a href="<?= base_url('barangmasuk/deleted') ?>" class="btn btn-warning mb-3 text-black">Deleted Barang Masuk</a>
              <?php endif; ?>
                ...
                <tbody>
                  <?php $ms = 1; foreach ($love as $key => $value) { ?>
                    <tr>
                      ...
                      <td>
                        <button class="btn btn-info btn-detail" data-id="<?= $value->id_masuk ?>"><i class="bi bi-info-circle" style="color: white;"></i></button>
                        <div class="btn-group btn-group-action mt-2" id="action-<?= $value->id_masuk ?>" style="display: none;"> 
                          <?php if ($level === '1'): ?>

                          <a href="<?= base_url('barangmasuk/soft/' . $value->id_masuk) ?>" class="btn btn-danger btn-delete"><i class="bi bi-trash"></i></a><pre></pre> <!-- hapus -->
                          <?php endif; ?>
                          
                          <a href="<?= base_url('barangmasuk/edit/' . $value->id_masuk) ?>" class="btn btn-warning"><i class="bi bi-pencil" style="color: white;"></i></a> <!-- edit -->
                        </div>
