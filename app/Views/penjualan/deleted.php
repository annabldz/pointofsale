    ...
    <div class="pagetitle">
      <h1>Tabel Deleted Barang</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Home</a></li>
          <li class="breadcrumb-item">Table Data</li>
          <li class="breadcrumb-item active">Deleted Data Barang</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <pre></pre>
             <a href="<?= base_url('/barang') ?>" class="btn btn-info mb-3 text-white">Back to Barang</a>
                  ...
                  <?php $ms = 1; foreach ($love as $key => $value) { ?>
                    <tr>
                      ...
                      <td>
                          ...
                          <a href="<?= base_url('/barang/restore/' . $value->id_barang) ?>" class="btn btn-danger btn-delete"><i class="bi bi-arrow-counterclockwise"></i></a><pre></pre> <!-- restore -->
                        </div>
                      </td>
                    </tr>
                  <?php } ?>
